    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-col gap-1 my-4 items-center">
                    ...
                    <input
                        ...
                        name="todo"
                        className="border border-gray-900 w-80 p-3 rounded-md"
                        type="text"
                ...
                <div className="flex justify-end justify-center mx-auto justify-between w-80">
                    <Link
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`bg-blue-700 hover:bg-blue-800 px-4 py-2 rounded-md transition text-white flex justify-center items-center gap-2 ${loading ? "opacity-75" : ""
                            }`}
                    >
                        {loading ? (
                            <svg
